...
function normalizeWorkspace(source) {
  ...
  const normalizeResponse = (response, index) => {
    ...
    return { ...record, id: record.id ?? index + 1, saved: true, submittedAt, scale: record.scale ?? null, scaleAnswers: record.scaleAnswers && typeof record.scaleAnswers === "object" ? record.scaleAnswers : {}, answers: record.answers && typeof record.answers === "object" ? record.answers : {} };
  };
