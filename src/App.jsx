...
function FormsView({ workspace, update, onNavigate }) {
  ...
  const exportForm = () => { const exportData = { title: formTitle, questions: workspace.forms, settings: formSettings, response: workspace.lastFormResponse ?? null }; downloadText(`${safeFileName(formTitle || "crescent-form")}.json`, JSON.stringify(exportData, null, 2), "application/json"); emitNotice("Form export downloaded."); };
